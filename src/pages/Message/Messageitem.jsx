            ...
            <div className=" flex justify-between">
              <div className=" flex gap-[25px] ">
                ...
                <img
                  ...
                  className=" lg:w-[6%] md:w-[30%] w-[4%] h-[fit-content] rounded-full"
                  alt=""
                />
                <div className="flex flex-col">
              ...
              <div className=" flex gap-2 w-[40%] justify-end">
                <button className=" text-white h-[5vh] bg-blue-500 rounded-md w-[40px] flex justify-center items-center py-1 px-2">
                  <BsTelephone />
                </button>
                ...
                <button className=" text-gray-700 h-[5vh] bg-gray-300 rounded-md w-[40px] flex justify-center items-center py-1 px-2">
                  ...
                </button>
              </div>
            </div>
